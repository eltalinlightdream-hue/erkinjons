...
import { Youtube, Send, GraduationCap, MapPin, Award, PenLine } from "lucide-react";
        ...
        <div className="grid md:grid-cols-[280px,1fr] gap-10 items-start">
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <a href="https://www.youtube.com/@erkinjon_writes" target="_blank" rel="noreferrer" className="flex-1">
