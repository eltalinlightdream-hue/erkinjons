...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Free IELTS materials, online practice, and premium lessons from an experienced teacher in Uzbekistan. IELTS Band 8.0." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Abduraimov Erkinjon - IELTS practise materials." },
      { name: "twitter:description", content: "Free IELTS materials, online practice, and premium lessons from an experienced teacher in Uzbekistan. IELTS Band 8.0." },
